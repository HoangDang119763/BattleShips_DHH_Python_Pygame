...
pgamegriding = load_image(r'assets/images/grids/player_grid.png',
                          ((row + 1) * cellSizeY, (col + 1) * cellSizeY))
cgamegriding = load_image(r'assets/images/grids/comp_grid.png',
                          ((row + 1) * cellSizeY, (col + 1) * cellSizeY))
    ...
    for col in range(8):
        explosionimagelist.append(
            load_sprite_sheet_images(explosionspritesheet, row, col, (cellSizeY, cellSizeY),
                                     (128, 128)))
radargridimages = load_animation_images(r'assets/images/radar_base/radar_anim', 360,
                                        ((row + 3) * cellSizeY, (col + 3) * cellSizeY))
radarblipimages = load_animation_images(r'assets/images/radar_blip/Blip_', 11, (cellSizeY, cellSizeY))
radargrid = load_image(r'assets/images/grids/grid_faint.png', ((row + 3) * cellSizeY, (col + 3) * cellSizeY))
...
FLEET = {
    ...
    'battleship': ['battleship', r'assets/images/ships/battleship/battleship.png',
                   ...
                   (30, cellSizeY * 4 - 5),
                   4, r'assets/images/ships/battleship/battleshipgun.png', (0.4, 0.125),
...
FLEET1 = {
    ...
    """Giữa bên trái 3 đơn vị"""
    'destroyer': ['destroyer', r'assets/images/ships/destroyer/destroyer.png',
                  (SCREENWIDTH // 2 - cellSizeX * 3, cellSizeX), (30, cellSizeY * 3 - 5),
                  2, 'assets/images/ships/destroyer/destroyergun.png', (0.5, 0.15), [-0.52, 0.71]],
    """Giữa bên phải 1 đơn vị"""
    'carrier': ['carrier', 'assets/images/ships/carrier/carrier.png',
                (SCREENWIDTH // 2 + cellSizeX, cellSizeX),
...
FLEET2 = {
    ...
    """Giữa bên trái 2 đơn vị"""
    'patrol boat': ['patrol boat', 'assets/images/ships/patrol boat/patrol boat.png',
                    (SCREENWIDTH // 2 - cellSizeX * 2, cellSizeX), (25, cellSizeY * 2 - 5),
                    0, '', None, None],
    """Giữa bên trái 3 đơn vị"""
    'patrol boat': ['patrol boat', 'assets/images/ships/patrol boat/patrol boat.png',
                    (SCREENWIDTH // 2 - cellSizeX * 3, cellSizeX), (25, cellSizeY * 2 - 5),
    ...
    """Giữa bên phải 1 đơn vị"""
    'submarine': ['submarine', 'assets/images/ships/submarine/submarine.png',
                  (SCREENWIDTH // 2 + cellSizeX, cellSizeX), (30, 145),
                  1, 'assets/images/ships/submarine/submarinegun.png', (0.25, 0.125), [-0.45]],
    """Giữa bên phải 2 đơn vị"""
    'submarine': ['submarine', 'assets/images/ships/submarine/submarine.png',
                  (SCREENWIDTH // 2 + cellSizeX * 2, cellSizeX), (30, 145),
...
FLEET3 = {
    ...
    """Giữa bên phải 1 đơn vị"""
    'destroyer': ['destroyer', r'assets/images/ships/destroyer/destroyer.png',
                  (SCREENWIDTH // 2 + cellSizeX, cellSizeX), (30, cellSizeY * 3 - 5),
                  2, 'assets/images/ships/destroyer/destroyergun.png', (0.5, 0.15), [-0.52, 0.71]],
}
...
FLEET4 = {
    ...
    """Giữa bên phải 1 đơn vị"""
    'rescue ship': ['rescue ship', 'assets/images/ships/rescue ship/rescue ship.png',
                    (SCREENWIDTH // 2 + cellSizeX, cellSizeX), (25, cellSizeY * 2 - 5),
                    0, '', None, None]
}
...
FLEET5 = {
    """Giữa"""
    'destroyer': ['destroyer', r'assets/images/ships/destroyer/destroyer.png',
                  (SCREENWIDTH // 2, cellSizeX), (30, cellSizeY * 3 - 5),
                  2, 'assets/images/ships/destroyer/destroyergun.png', (0.5, 0.15), [-0.52, 0.71]],
    """Giữa bên trái 1 đơn vị"""
    'patrol boat': ['patrol boat', 'assets/images/ships/patrol boat/patrol boat.png',
                    (SCREENWIDTH // 2 - cellSizeX, cellSizeX), (25, cellSizeY * 2 - 5),
