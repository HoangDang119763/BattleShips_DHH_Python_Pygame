...
pgamegriding = load_image('assets/images/grids/player_grid_20x20.png',
                          ((row + 1) * cellSizeY, (col + 1) * cellSizeY))
cgamegriding = load_image('assets/images/grids/comp_grid_20x20.png',
                          ((row + 1) * cellSizeY, (col + 1) * cellSizeY))
...
radargrid = load_image('assets/images/grids/grid_faint_20x20.png', ((row + 13) * cellSizeY, (col + 13) * cellSizeY))
